...
model = dict(
    ...
    neck=dict(
        type="RPNP2",
        interp_cfg=dict(
            conv3=dict(planes=64, kernel=2, voxel_size=[0.075*4, 0.075*4, 0.2*4]),
            conv4=dict(planes=128, kernel=1, voxel_size=[0.075*8, 0.075*8, 0.2*8])
        ),
        pool_cfg=dict(radius=0.075*8, bev=0.075*8),
        layer_nums=[5, 5],
