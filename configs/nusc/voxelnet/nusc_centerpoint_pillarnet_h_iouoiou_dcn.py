...
tasks = [
    ...
    dict(stride=4, class_names=["barrier"]),
    dict(stride=4, class_names=["motorcycle", "bicycle"]),
    dict(stride=4, class_names=["pedestrian", "traffic_cone"]),
]
...
model = dict(
    ...
    backbone=dict(
        type="SpMiddlePillarEncoder34HA", ds_factor=8, double=2,
