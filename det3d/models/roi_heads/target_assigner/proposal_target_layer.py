...
class ProposalTargetLayer(nn.Module):
    ...
    def sample_rois_for_rcnn(self, batch_dict):
        ...
        with_features = 'roi_features' in batch_dict.keys()
        roi_features = batch_dict['roi_features'] if with_features else torch.zeros_like(gt_boxes)
        ...
        if with_features:
            ...
            return batch_rois, batch_gt_of_rois, batch_roi_ious, batch_roi_scores, batch_roi_labels, None
