...
class SingleStageDetector(BaseDetector):
    def __init__(
        ...
        self.reader = builder.build_reader(reader) if reader is not None else None
        self.backbone = builder.build_backbone(backbone) if backbone is not None else None
        if neck is not None:
