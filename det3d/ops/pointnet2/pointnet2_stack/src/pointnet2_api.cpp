...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("roi_cylinder_pool3d_wrapper", &roi_cylinder_pool3d_wrapper, "roi_cylinder_pool3d_wrapper");
    m.def("roi_cuboid_pool3d_wrapper", &roi_cuboid_pool3d_wrapper, "roi_cuboid_pool3d_wrapper");
